...
/**
 * Global exception-to-response mapper for review-service APIs.
 */
...
public class ApiExceptionHandler {
    ...
    /**
     * Maps review operation failures to configured status codes.
     *
     * @param ex review operation exception
     * @param request current HTTP request
     * @return operation failure envelope
     */
    @ExceptionHandler(ReviewOperationException.class)
    public ResponseEntity<ApiResponse<Void>> handleReviewOperation(
