...
/**
 * Standard API envelope returned by Checkout Service endpoints.
 *
...
public class ApiResponse<T> {
    ...
    /**
     * Resolves the current request correlation ID from MDC.
     *
     * @return correlation ID, or {@code null} if not present
     */
