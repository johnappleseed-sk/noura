...
public class ShippingRequestContextResolver {
     ...
     */
    public ShippingRequestContext resolve(HttpServletRequest request) {
        ...
        return new ShippingRequestContext(subject, authorization, roles, internalCall);
    }
