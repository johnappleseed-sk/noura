...
/**
 * Global exception-to-response mapper for cart APIs.
 */
...
public class ApiExceptionHandler {
    ...
    /**
     * Maps cart business-rule and downstream operation failures.
     *
     * @param ex cart operation exception
     * @param request current HTTP request
     * @return operation failure envelope
     */
    @ExceptionHandler(CartOperationException.class)
    public ResponseEntity<ApiResponse<Void>> handleOperation(CartOperationException ex, HttpServletRequest request) {
