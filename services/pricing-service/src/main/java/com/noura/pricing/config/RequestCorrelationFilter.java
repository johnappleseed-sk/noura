...
public class RequestCorrelationFilter extends OncePerRequestFilter {
    ...
    /** Correlation header name propagated by the service. */
     ...
     *
     * @param headerValue inbound header value
     * @return existing correlation ID if valid; otherwise generated UUID
     */
