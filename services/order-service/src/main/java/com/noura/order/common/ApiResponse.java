...
/**
 * Standard API envelope returned by Order Service endpoints.
 *
...
public class ApiResponse<T> {
     ...
     *
     * @return correlation identifier, or {@code null} if not present
     */
    ...
    public record ErrorBody(String code, String detail, Map<String, String> validationErrors) {
        ...
        /**
         * Creates an error payload without field-level validation details.
         *
         * @param code machine-readable error code
         * @param detail human-readable detail
         */
