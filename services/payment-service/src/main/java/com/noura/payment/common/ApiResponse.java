...
/**
 * Standard API envelope returned by Payment Service endpoints.
 *
...
public class ApiResponse<T> {
     ...
     * @param code stable machine-readable error code
     * @param detail human-readable detail
     * @param validationErrors field-level validation details
     * @param path request path
     * @param <T> payload type
     * @return failure response envelope
     */
     ...
     * @param detail human-readable detail
     * @param validationErrors optional per-field validation details
     */
