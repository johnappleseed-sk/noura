...
/**
 * Standard API envelope returned by the Inventory Service.
 *
...
public class ApiResponse<T> {
     ...
     * @return successful response envelope with correlation metadata
     */
     ...
     * @param path request path
     * @param <T> payload type (usually {@code Void} for failures)
     ...
     * @param path request path
     * @param <T> payload type (usually {@code Void} for failures)
     * @return failure response envelope including validation details
     */
    ...
    /**
     * Resolves the current request correlation identifier from MDC.
     *
     * @return correlation identifier, or {@code null} if not set
     */
