...
public class PromotionRequestContextResolver {
     ...
     */
    public PromotionRequestContext resolve(HttpServletRequest request) {
        ...
        return new PromotionRequestContext(subject, authorization, roles, internalCall);
    }
