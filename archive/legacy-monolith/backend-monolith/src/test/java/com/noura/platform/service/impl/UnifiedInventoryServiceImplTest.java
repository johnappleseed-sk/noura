...
class UnifiedInventoryServiceImplTest {
    ...
    void createWarehouseDelegatesToPlatformInventoryService() {
        WarehouseRequest request = new WarehouseRequest("Main Warehouse", "Phnom Penh", null, true);
        WarehouseDto expected = new WarehouseDto(UUID.randomUUID(), "Main Warehouse", "Phnom Penh", null, true);
