...
public interface ProductService {
    ProductResponse createAdminProduct(CreateProductRequest request);

    Page<ProductResponse> listAdminProducts(String query, ProductStatus status, Pageable pageable);

    ProductResponse getAdminProduct(UUID productId);
    ...
    ProductMediaDto updateMedia(UUID productId, UUID mediaId, ProductMediaRequest request);
