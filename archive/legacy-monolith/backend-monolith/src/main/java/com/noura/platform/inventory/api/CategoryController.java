...
/**
 * Exposes governed inventory category administration APIs.
 */
@Validated
@RestController
...
public class CategoryController {
     ...
     * @param active The optional active-state filter.
     ...
     * @return The paginated inventory category response.
     */
    @GetMapping
    ...
    /**
     * Lists the governed inventory category tree.
     *
    ...
    /**
     * Moves an inventory category to governed trash.
     *
     * @param categoryId The inventory category identifier.
     * @param http The current HTTP request.
     * @return The empty response envelope.
     */
    @DeleteMapping("/{categoryId}")
    @PreAuthorize("hasRole('ADMIN')")
    public ApiResponse<Void> deleteCategory(@PathVariable String categoryId, HttpServletRequest http) {
        categoryService.deleteCategory(categoryId);
        return ApiResponse.ok("Category moved to trash", null, http.getRequestURI());
    }
}
