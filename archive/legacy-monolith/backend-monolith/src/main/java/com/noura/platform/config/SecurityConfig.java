...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, appProperties.getApi().getVersionPrefix() + "/auth/login").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/payments/webhooks/mock").permitAll()
                        .requestMatchers(HttpMethod.POST, appProperties.getApi().getVersionPrefix() + "/payments/webhooks/mock").permitAll()
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/system/health").permitAll()
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/system/readiness").permitAll()
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/system/liveness").permitAll()
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/system/health/readiness").permitAll()
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/system/health/liveness").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, appProperties.getApi().getVersionPrefix() + "/stores/nearest").permitAll()
                ...
                .addFilterAfter(apiRequestLoggingFilter, RateLimitFilter.class)
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        cors.setExposedHeaders(List.of("Authorization", "X-Correlation-ID", "X-Correlation-Id"));
