...
CREATE INDEX IF NOT EXISTS idx_stock_movement_product_created ON stock_movement (product_id, created_at);
CREATE INDEX IF NOT EXISTS idx_stock_movement_type_created ON stock_movement (movement_type, created_at);
...
CREATE INDEX IF NOT EXISTS idx_purchase_order_item_product ON purchase_order_item (product_id);
...
CREATE INDEX IF NOT EXISTS idx_goods_receipt_item_grn ON goods_receipt_item (grn_id);
CREATE INDEX IF NOT EXISTS idx_goods_receipt_item_product ON goods_receipt_item (product_id);
