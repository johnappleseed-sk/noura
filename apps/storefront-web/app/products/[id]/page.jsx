      ...
      <section className="featured-section" style={{ paddingTop: 32 }}>
        <div className="container">
          <div className="pdp-layout">
            {/* Image */}
            <div className="pdp-image panel" style={{ position: 'relative', minHeight: 480, overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--line-light)' }}>
              {product.imageUrl ? (
                <Image
                ...
                <span style={{ fontSize: '1.5rem', color: 'var(--muted)' }}>{product.categoryName || 'Product'}</span>
              )}
            </div>
