...
export function InventoryPage() {
  ...
  async function load(selectedFilters = filters) {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Failed to load stock levels.'))
    } finally {
      setLoading(false)
    }
  }
  ...
  return (
    <div className="page">
      ...
      <section className="panel">
        ...
        <form className="control-toolbar" onSubmit={handleFilterSubmit}>
          ...
          <label className="toolbar-toggle-field">
            <span>Low stock</span>
      ...
      <section className="panel">
        ...
        {!canAdjust ? (
          <div className="panel" style={{ marginBottom: 14 }}>
            <p className="subtle-meta">Your role is read-only in this screen. Use an admin or warehouse-manager account to post adjustments.</p>
          </div>
        ) : null}
