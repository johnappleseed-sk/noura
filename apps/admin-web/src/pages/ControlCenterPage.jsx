...
export function ControlCenterPage() {
  ...
  useToastFeedback({ errorMessage: workbenchError })
  ...
  async function load() {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Unable to load control center data.'))
    } finally {
      setLoading(false)
    }
  }
  ...
  async function executeWorkbench() {
    ...
    try {
      ...
      setWorkbenchError(getErrorMessage(err, 'Unable to execute request.'))
    } finally {
          ...
          <div className="workbench-console">
            ...
            {workbenchError ? (
              <div className="panel" style={{ marginBottom: 12 }}>
                <p className="subtle-meta">{workbenchError}</p>
              </div>
            ) : null}
