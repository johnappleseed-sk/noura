...
export function ReportsPage() {
  ...
  async function handleScan(event) {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Failed to run scan simulation.'))
    } finally {
  ...
  return (
    <div className="page">
      ...
      <section className="panel">
        ...
        <form className="control-toolbar" onSubmit={applyFilters}>
          <label className="toolbar-field">
            <span>Warehouse</span>
            <select className="toolbar-control" value={filters.warehouseId} onChange={(event) => setFilters((current) => ({ ...current, warehouseId: event.target.value }))}>
          ...
          <label className="toolbar-field">
            <span>Product</span>
            <select className="toolbar-control" value={filters.productId} onChange={(event) => setFilters((current) => ({ ...current, productId: event.target.value }))}>
          ...
          <label className="toolbar-field">
            <span>Date from</span>
            <input className="toolbar-control" type="datetime-local" value={filters.dateFrom} onChange={(event) => setFilters((current) => ({ ...current, dateFrom: event.target.value }))} />
          </label>

          <label className="toolbar-field">
            <span>Date to</span>
            <input className="toolbar-control" type="datetime-local" value={filters.dateTo} onChange={(event) => setFilters((current) => ({ ...current, dateTo: event.target.value }))} />
          </label>

          <div className="toolbar-actions">
            <button className="btn btn-primary toolbar-btn" type="submit">
              Apply filters
            </button>
            <button
