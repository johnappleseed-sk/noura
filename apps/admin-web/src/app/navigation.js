...
export const NAV_SECTIONS = [
  ...
  },
  {
    label: 'Network',
    items: [
      { label: 'Merchants', to: '/admin/merchants', icon: 'users', capability: CAPABILITIES.NETWORK_MERCHANTS },
      { label: 'Stores', to: '/admin/stores', icon: 'warehouse', capability: CAPABILITIES.NETWORK_STORES },
      { label: 'Submissions', to: '/admin/product-submissions', icon: 'box', capability: CAPABILITIES.GOVERNANCE_PRODUCT_SUBMISSIONS }
    ]
  },
  {
    label: 'Commerce',
    items: [
      ...
      { label: 'Service areas', to: '/admin/service-areas', icon: 'warehouse', capability: CAPABILITIES.COMMERCE_STORES },
  ...
  },
  {
    label: 'Governance',
    items: [
      { label: 'Recovery center', to: '/admin/governance/recovery', icon: 'chart', capability: CAPABILITIES.GOVERNANCE_RECOVERY },
      { label: 'Roles & permissions', to: '/admin/governance/roles-permissions', icon: 'users', capability: CAPABILITIES.GOVERNANCE_RBAC }
    ]
  },
  {
    label: 'Tools',
