...
export function EnterpriseInventoryPanel() {
  ...
  async function load() {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Unable to load enterprise inventory data.'))
    } finally {
      setLoading(false)
    }
  }
  ...
  async function handleTransferSubmit(event) {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Unable to create transfer.'))
    } finally {
      setSaving(false)
    }
  }
  ...
  async function handleRestockSubmit(event) {
    ...
    try {
      ...
      setError(getErrorMessage(err, 'Unable to create restock schedule.'))
    } finally {
      setSaving(false)
    }
  }
