...
| admin-dashboard | frontend/admin-dashboard/src/shared/api/endpoints/pricingApi.js | listPromotions | GET `/api/v1/admin/promotions` | GET `/api/v1/admin/promotions` | Keep | Query, active, and archived filters supported. |
| admin-dashboard | frontend/admin-dashboard/src/shared/api/endpoints/pricingApi.js | getPromotion | GET `/api/v1/admin/promotions/{promotionId}` | GET `/api/v1/admin/promotions/{promotionId}` | Keep | - |
| admin-dashboard | frontend/admin-dashboard/src/shared/api/endpoints/pricingApi.js | updatePromotion | PATCH `/api/v1/admin/promotions/{promotionId}` | PATCH `/api/v1/admin/promotions/{promotionId}` | Keep | - |
| admin-dashboard | frontend/admin-dashboard/src/shared/api/endpoints/pricingApi.js | evaluatePromotions | POST `/api/v1/admin/promotions/evaluate` | POST `/api/v1/admin/promotions/evaluate` | Keep | Deterministic evaluation now served by promotion-service. |
