...
- Added `serviceResolution=<mode>` to the gateway startup summary log so boot output clearly states whether upstream routing is expected through explicit URLs or discovery.
